...
export const accessLogsApi = {
  list: (params?: { tenant_id?: number; api_key_id?: number; limit?: number }) =>
    api
      .get<PaginatedResponse<AccessLog>>('/api/v1/admin/access-logs', { params })
      .then((r) => ({
        ...r,
        data: r.data.data,
...
export const diagnosticsApi = {
  get: () =>
    api
      .get<APIResponse<DiagnosticsData>>('/api/v1/admin/diagnostics')
      .then((r) => ({
        ...r,
        data: r.data.data,
      })),
...
export const configApi = {
  get: () =>
    api
      .get<APIResponse<ConfigData>>('/api/v1/admin/config')
      .then((r) => ({
        ...r,
        data: r.data.data,
      })),
  update: (data: Partial<ConfigData>) =>
    api
      .patch<APIResponse<ConfigUpdateResponse>>('/api/v1/admin/config', data)
      .then((r) => ({
        ...r,
        data: r.data.data,
      })),
...
export const dsnsApi = {
  list: () =>
    api
      .get<APIResponse<DSNsData>>('/api/v1/admin/dsns')
      .then((r) => ({
        ...r,
        data: r.data.data,
      })),
...
export const testDsnApi = {
  test: (data: TestDSNRequest) =>
    api
      .post<APIResponse<TestDSNResponse>>('/api/v1/admin/test-dsn', data)
      .then((r) => ({
        ...r,
        data: r.data.data,
      })),
...
export const testAgentApi = {
  test: (data: TestAgentRequest) =>
    api
      .post<APIResponse<TestAgentResponse>>('/api/v1/admin/test-agent', data)
      .then((r) => ({
        ...r,
        data: r.data.data,
      })),
